<template>
    <div class="app-container">
        ...
        <el-table v-loading=" loading " :data=" goodsList " @selection-change=" handleSelectionChange " border fit
            ...
            <el-table-column label="商品分类" prop="categoryName" width="100" align="center" />
            <el-table-column label="商品价格" prop="price" width="100" align="center">
            ...
            <el-table-column label="商品描述" prop="goodsDesc" min-width="200" />
...
export default {
    ...
    methods: {
        ...
        {
            this.loading = true
            // 传递包含排序参数的queryParams给后端
            goodsApi.pageGoods(this.queryParams).then(res =>
            {
                // 即使后端返回数据，前端再做一次全局ID升序排序（确保跨页数据正确）
        ...
        {
            this.categoryList = [
                { id: 1, categoryName: '数码产品' },
                { id: 2, categoryName: '家居用品' },
                { id: 3, categoryName: '服饰鞋帽' }
            ]
        },
